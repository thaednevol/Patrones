...
public class FTPGUI extends JFrame {
  /**
	 * 
	 */
	private static final long serialVersionUID = 5183120160275292529L;
...
//    }
  ...
  class UploadButton extends JButton 
	 ...
	 * 
	 */
	private static final long serialVersionUID = -205012364134615380L;
	public void processEvent() {
  ...
  class DownloadButton extends JButton 
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6446580347106592703L;
	public void processEvent() {
  ...
  class DeleteButton extends JButton 
	 ...
	 * 
	 */
	private static final long serialVersionUID = -708624456396079487L;
	public void processEvent() {
      int index = localList.getSelectedIndex();
      if (index >= 0) {
        ((DefaultListModel<String>) localList.getModel()).remove(
  ...
  class ExitButton extends JButton 
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1281792915049137434L;
	public void processEvent() {
      System.exit(1);
    }
